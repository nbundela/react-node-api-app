...
const onDateMapping = (data) => {
    console.log("onDataMapping")
    console.log("-----------")
    data.forEach((item) => {
...
const List = () => {
    ...
    const {data, fetchArchiveStatusAPI} = useContext(ListContext);
    //const list = onDateMapping(data);
    const list = useMemo(() => onDateMapping(data), [data]);
